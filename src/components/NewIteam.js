    ...
    render() {
        ...
        return (
            ...
            <div className="card">
               ...
               <a href={"/tin/"+this.props.tieuDe1+"-"+this.props.tinId+".html"}><img className="card-img-top" src={this.props.anh1}
            ...
            <div className="row">
                ...
                <div className="btn  btn-primary fa fa-shopping-cart" onClick={() => this.editClick()} >  Oder </div>
